...
//mane ki :3
//ei api gula amar pcn er jonno o kora
//jokhon android e kaj korbo tokhon lagbe edi
//agei kora silo amar api te :3
//aissa. ekn ghum dhorse . :3

//assa ar kono kon jaygay problem ektu point out koira rakhis
//problem nai. amr pc bal :3
//:v :v :v amare dia de :v
//otou bal na :v
//mara kha hala chudir vai ass
//assa hon eid apush koira daw
//wait ami ditasi
//project niya kisu korte hobe :3
// like at least bus route diya app
// manush re koite hoibo data dewar jnno :p
//hoo amio raji data collect kora lagbo :3
...
if($dirrectionId == $mrtStartP1){     //$mrtStartP1 er stationId
    ...
    echo json_encode(array("time_data"=>$jsonFood,$status=>1,$message=>"Success"));
}
