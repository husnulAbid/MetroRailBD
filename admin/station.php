    ...
    <div class="mainbody" style="margin-top: 130px;color:#333;">
        <!-- Main Body -->
                        ...
                        <div class="panel-body">
                            <form action="../Api/admin/insert_station.php" method="post">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Station Name" name="stationName" type="text" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Longitude" name="Longitude" type="text" value="">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Latitude" name="Latitude" type="text" value="">
                                    </div>
                                    ...
                                    success: function (data) {
                                        ...
                                        for (var key in datas) {
                                            if (datas.hasOwnProperty(key)) {
                                                ...
                                                cell1.innerHTML = ""+datas[key].stationId;
                                                cell2.innerHTML = ""+datas[key].stationName;
                                                cell3.innerHTML = ""+datas[key].Longitude;
                                                cell4.innerHTML = ""+datas[key].Latitude;
